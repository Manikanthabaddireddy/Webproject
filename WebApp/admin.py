...
class Fin_Admin(admin.ModelAdmin):
    list_display=['Lead_Number','Customer_Phone_Number','Customer_Name','Date_Of_Function','Price_Agreed','Total_amount_Received_So_Far','Add_Money','Email_Receipt','Print_Receipt']
